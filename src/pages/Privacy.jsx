    ...
    <div className="min-h-screen bg-[#F2F2F2]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-[#6B7280]">איך אנחנו שומרים על המידע שלכם</p>
        </div>
        ...
        <div className="space-y-8">
          <Card className="shadow-lg bg-white border-0">
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-[#1A1A1A]">
                <Eye className="w-6 h-6 text-[#1D4E8F]" />
                איסוף מידע
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="shadow-lg bg-white border-0">
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-[#1A1A1A]">
                <Lock className="w-6 h-6 text-[#1D4E8F]" />
                אבטחת מידע
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="shadow-lg bg-white border-0">
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-[#1A1A1A]">
                <Database className="w-6 h-6 text-[#1D4E8F]" />
                שמירה ומחיקת מידע
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <div className="bg-white border border-[#1D4E8F] rounded-lg p-6">
            <h3 className="font-semibold text-[#1D4E8F] mb-2">יצירת קשר בנושא פרטיות</h3>
            <p className="text-[#6B7280]">
              לשאלות או בקשות בנוגע למדיניות הפרטיות, אנא פנו אלינו באמצעות דף "צור קשר" או ישירות למייל: 
              <strong className="mr-2 text-[#2560B0]">sniryulzari@gmail.com</strong>
            </p>
          </div>
        </div>
      </div>
